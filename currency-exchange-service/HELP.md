...
* The original package name 'com.example.microservices.currency-exchange-service' is invalid and this project uses 'com.example.microservices.currencyexchangeservice' instead.
